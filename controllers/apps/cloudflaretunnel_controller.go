...
import (
	...
	"github.com/arturoguerra/cloudflare-tunnel-operator/apis/apps/v1alpha1/cloudflared"
	"github.com/arturoguerra/cloudflare-tunnel-operator/internal/dependencies"
	"github.com/arturoguerra/cloudflare-tunnel-operator/internal/mutate"
)
...
func NewCloudflareTunnelReconciler(mgr ctrl.Manager) *CloudflareTunnelReconciler {
	return &CloudflareTunnelReconciler{
		Name:         "CloudflareTunnel",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorderFor("CloudflareTunnel-Controller"),
		FieldManager: "CloudflareTunnel-reconciler",
		Log:          ctrl.Log.WithName("controllers").WithName("apps").WithName("CloudflareTunnel"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
	}
}

// +kubebuilder:rbac:groups=apps.ar2ro.io,resources=cloudflaretunnels,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apps.ar2ro.io,resources=cloudflaretunnels/status,verbs=get;update;patch
...
func (r *CloudflareTunnelReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
...
func (r *CloudflareTunnelReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &appsv1alpha1.CloudflareTunnel{}
...
func (r *CloudflareTunnelReconciler) GetResources(req *workload.Request) ([]client.Object, error) {
	component, err := cloudflared.ConvertWorkload(req.Workload)
	if err != nil {
		return nil, err
	}

	return cloudflared.Generate(*component, r, req)
}

// GetEventRecorder returns the event recorder for writing kubernetes events.
func (r *CloudflareTunnelReconciler) GetEventRecorder() record.EventRecorder {
	return r.Events
}

// GetFieldManager returns the name of the field manager for the controller.
func (r *CloudflareTunnelReconciler) GetFieldManager() string {
	return r.FieldManager
}

// GetLogger returns the logger from the reconciler.
func (r *CloudflareTunnelReconciler) GetLogger() logr.Logger {
	return r.Log
}

// GetName returns the name of the reconciler.
func (r *CloudflareTunnelReconciler) GetName() string {
	return r.Name
}

// GetController returns the controller object associated with the reconciler.
func (r *CloudflareTunnelReconciler) GetController() controller.Controller {
	return r.Controller
}

// GetWatches returns the objects which are current being watched by the reconciler.
func (r *CloudflareTunnelReconciler) GetWatches() []client.Object {
	return r.Watches
}

// SetWatch appends a watch to the list of currently watched objects.
func (r *CloudflareTunnelReconciler) SetWatch(watch client.Object) {
	r.Watches = append(r.Watches, watch)
}

// CheckReady will return whether a component is ready.
func (r *CloudflareTunnelReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.CloudflareTunnelCheckReady(r, req)
}
...
func (r *CloudflareTunnelReconciler) Mutate(
	req *workload.Request,
	object client.Object,
) ([]client.Object, bool, error) {
	return mutate.CloudflareTunnelMutate(r, req, object)
}
...
func (r *CloudflareTunnelReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	baseController, err := ctrl.NewControllerManagedBy(mgr).
		...
		For(&appsv1alpha1.CloudflareTunnel{}).
		Build(r)
	if err != nil {
