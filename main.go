...
import (
	...
	appscontrollers "github.com/arturoguerra/cloudflare-tunnel-operator/controllers/apps"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "5646cb03.ar2ro.io",
	})
	if err != nil {
	...
	reconcilers := []ReconcilerInitializer{
		appscontrollers.NewCloudflareTunnelReconciler(mgr),
